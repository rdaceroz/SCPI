...
<form class="form-horizontal" action="" method="post" accept-charset="utf-8">
    ...
    <div class="form-group">
        <label class="col-md-4 control-label">Cod. Proyecto</label>
        <div class="col-md-3"><input class="form-control" name="cproyecto" maxlength="10" type="text" id="cproyecto"/></div>
        <div class="col-md-5"id="nombreproyecto"></div>
    </div>
